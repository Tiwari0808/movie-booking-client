...
const MovieCard = ({movie}) => {
    ...
    return (
        <div className='relative p-3 w-[268px] h-[356px] bg-[#12161C] rounded-[16px] flex flex-col gap-[1rem]'>
            ...
            <div className='flex items-center justify-between mt-5'>
                <button className='w-[6rem] bg-primary rounded-full p-1.5'>Buy Ticket</button>
